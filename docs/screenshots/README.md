...
Norwegian abstract translation and generated summaries are intentionally not shown because they are planned for a later update.

Do not include personal data, local filesystem paths, API keys, or unrelated browser content in screenshots.
